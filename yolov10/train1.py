...
if __name__ == '__main__':
    # single_train_v10_pre('ultralytics/cfg/models/v10/yolov10n_DCNv4.yaml','D:\\workspace_py\\ultralytics\\ultralytics\\cfg\\datasets\\plantdoc.yaml','plantdoc_yolov10n_DCNv4')


    single_train_v10_pre('ultralytics/cfg/models/v10/yolov10n_DCNv4.yaml',
                         'D:\\workspace_py\\ultralytics\\ultralytics\\cfg\\datasets\\plantdoc.yaml', 'plantdoc_yolov10n_DCNv4')

    # single_train_v10_pre('ultralytics/cfg/models/v10/yolov10n_DCNv3.yaml','D:\\workspace_py\\ultralytics\\ultralytics\\cfg\\datasets\\plantdoc.yaml','plantdoc_v10_yolov10n_DCNv3')
    #
    # single_train_v10_pre('ultralytics/cfg/models/v10/yolov10n_DCNV3_EMA.yaml',
    #                      'D:\\workspace_py\\ultralytics\\ultralytics\\cfg\\datasets\\plantdoc.yaml', 'plantdoc_yolov10n_DCNV3_EMA')
    #
    #
    #
    # single_train_v10_pre('ultralytics/cfg/models/v10/yolov10n_DCNv4_EMA.yaml',
    #                      'D:\\workspace_py\\ultralytics\\ultralytics\\cfg\\datasets\\plantdoc.yaml', 'plantdoc_yolov10n_DCNv4_EMA')
