...
__all__ = ['DyHeadBlock', 'DyHeadBlockWithDCNV3', 'Fusion', 'C2f_Faster', 'C3_Faster', 'C3_ODConv', 'C2f_ODConv', 'Partial_conv3', 'C2f_Faster_EMA', 'C3_Faster_EMA', 'C2f_DBB',
           ...
           'C2f_AggregatedAtt', 'C3_AggregatedAtt', 'SDI', 'DCNV4_YOLO', 'C3_DCNv4', 'C2f_DCNv4','C2f_DCNv4_EMA', 'DyHeadBlockWithDCNV4', 'ChannelAttention_HSFPN', 'Multiply', 'DySample', 'CARAFE', 'HWD',
           ...
           'C3_Star', 'C2f_Star', 'C3_Star_CAA', 'C2f_Star_CAA', 'C3_KAN', 'C2f_KAN', 'PSEMA']
...
class Bottleneck_DCNV3_EMA(Bottleneck):
    """Standard bottleneck with DCNV3."""
    ...
    def forward(self, x):
        ...
        return self.attention(x + self.cv2(self.cv1(x)) if self.add else self.cv2(self.cv1(x)))
...
class C2f_DCNv3_EMA(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(Bottleneck_DCNV3_EMA(self.c, self.c, shortcut, g, k=(3, 3), e=1.0) for _ in range(n))
...
class Bottleneck_DCNV4_EMA(Bottleneck):
    """Standard bottleneck with DCNV3."""
...
class C2f_DCNv4_EMA(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(Bottleneck_DCNV4_EMA(self.c, self.c, shortcut, g, k=(3, 3), e=1.0) for _ in range(n))
