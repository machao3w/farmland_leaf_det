...
from ultralytics.nn.extra_modules.attention import SpatialAttention
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2fCIB, C2f_DCNv3, C2f_DCNv4, C2f_DCNv4_EMA):
            ...
            c2 = ch[f[-1]]
        elif m in {EMA, CoordAtt, CBAM,  CAA,}:
            c2 = ch[f]
            args = [c2, *args]
        else:
            c2 = ch[f]
